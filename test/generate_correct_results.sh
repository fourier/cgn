...
# type counts test
../tools/cgn_run_template.sh cgn_type_counts_test.xsl create-type-counts-xml-test cgn_type_counts_test.xml > $EXPECTED_DIR/cgn_type_counts_test_expected.xml
