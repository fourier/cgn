...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="2.0"
                ...
                xmlns:this="https://github.com/fourier/cgn/java/phase1">
  ...
  <xsl:variable name="this:namespace" select="(//namespace::*[name() = 'jcgn'])[1]"/>
  ...
  <xsl:template match="@jcgn:builder" mode="jcgn:phase1">
    <xsl:call-template name="cgn:boolean-attribute-preprocess">
      ...
      <xsl:with-param name="attribute-namespace" select="$this:namespace"/>
