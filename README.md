...
The Saxon XSLT and XQuery processor developed by [Saxonica](http://www.saxonica.com/), for convenience included in the repository.
...
```xml
  <objects cgn:package="com.mycompany.users" cgn:copyright="Copyright (c) 2014 by My Company&#10;This file and its contents are Confidential." >
...
/**
 * Generated from example.xml on 6/1/2015
 */
...
import com.mycompany.example.PersonalUserData;
...
public class Employee implements android.os.Parcelable {
    ...
    public Employee(android.os.Parcel in) {
        ...
        this.mProbation = in.readByte() == 0 ? false : true;
